export const hireMeBtn = [
  {
    svg: `
    <svg class="h-5" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path d="M4.02 42l41.98-18-41.98-18-.02 14 30 4-30 4z"/><path d="M0 0h48v48h-48z" fill="none"/></svg>`,

    load: `
    <svg
    aria-hidden="true"
    class="w-5 h-5 animate-spin dark:text-buttons_primary fill-primary"
    viewBox="0 0 100 101"
    fill="none"
