<template>
  <ul class="border border-[#999]/55 rounded-full py-4 w-12 h-fit">
    <a
      class="group pb-5 last:pb-0 tooltip tooltip-left flex items-center justify-center w-full cursor-pointer"
...
const svgs = ref([
  {
    svg: `<svg
        class="fill-[#999]/55 ease-in-out duration-300 group-hover:fill-[#28e98c]"
